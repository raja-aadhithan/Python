...
new_name = input("Enter contact's name:   ")
        names = new_name
        direc.append(new_name)
        phone_no = input("Enter contact's mobile no: ")
        try:
            phone_no = int(phone_no)
        except:
            print('Mobile number is not valid')
        email_id = input("Enter contact's Mail id:   ")
        old = input("Enter contact's Age: ")
        try:
            old = int(old)
        except:
            print('Mobile number is not valid')
        new_name = person(names,phone_no,email_id,old)
        print(new_name.name)
        chosen = print_menu()
        call(chosen)